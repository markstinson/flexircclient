...
package com.oosterwijk.irc
{
	...
	public class AsIrcClient
	{
		...
		public static var STATUS_HANDLING_CONNECT:String = "handling connect";
		public static var STATUS_CONNECTED:String        = "connected";
		public static var STATUS_DISCONNECTED:String     = "disconnected";
		...
		public function connect(host:String,port:int=6667,password:String=null):void
		{
	        ...
	        if (isConnected()) 
	        {
	            throw new IOError("The Flex IRC Client is already connected to an IRC server.  Disconnect first.");
	        }
